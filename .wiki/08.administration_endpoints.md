...
- **Endpoint**: `POST /scheduler/task/pause?groupId={groupId}&taskId={taskId}`
- **Endpoint**: `POST /scheduler/taskresume?groupId={groupId}&taskId={taskId}`
...
- **Endpoint**: `DELETE /scheduler`
- **Endpoint**: `DELETE /scheduler/group?groupId={groupId}`
- **Endpoint**: `DELETE /scheduler/task?groupId={groupId}&taskId={taskId}`
