...
package taskmanager.base.settings
...
import taskmanager.base.settings.AppSettings.configuration
import taskmanager.base.settings.AppSettings.load
import taskmanager.base.settings.catalog.ConfigurationCatalog
import taskmanager.base.settings.catalog.section.*
import taskmanager.base.settings.catalog.section.security.SecuritySettings
        ...
        val timeTaken: Long = measureTimeMillis {
            ...
            val catalogMappings: List<ConfigCatalogMap> = listOf(
                ...
                ConfigCatalogMap(
                    ...
                    catalogProperty = "communication",
                    propertyClass = CommunicationSettings::class
                ),
