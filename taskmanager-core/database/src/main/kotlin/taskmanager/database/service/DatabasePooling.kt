...
package taskmanager.database.service

import com.zaxxer.hikari.HikariConfig
import com.zaxxer.hikari.HikariDataSource
import io.micrometer.prometheusmetrics.PrometheusMeterRegistry
import taskmanager.base.settings.catalog.section.DatabaseSettings
import taskmanager.database.util.IsolationLevel
...
internal object DatabasePooling {
    ...
    fun createDataSource(
        ...
        val hikariConfig: HikariConfig = HikariConfig().apply {
            ...
            // Disables auto-commit mode on connections to allow explicit transaction management,
            // thereby preventing automatic commits after each single statement.
