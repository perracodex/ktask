...
public object DateTimeUtils {
    ...
    /**
     * Formats a LocalDateTime to a consistent ISO 8601 string with nanosecond precision.
     *
     * This extension function formats the LocalDateTime to the ISO 8601 standard, including year, month, day, hour,
     * minute, second, and nanoseconds, ensuring that nanoseconds are always displayed to 9 digits. For example:
     * `2024-11-13T14:20:32.015448000`.
     *
     * @return A string representation of the LocalDateTime in ISO 8601 format with fixed nanosecond precision.
     */
    public fun LocalDateTime.formatted(): String {
        ...
        val nanosecond: String = "%09d".format(this.nanosecond) // Pad to 9 digits.
        return "$year-$month-${day}T$hour:$minute:$second.$nanosecond"
    }
